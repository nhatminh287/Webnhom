...
<div id="page" class="page col-md-5">
    <div class="header">
        <div class="logo"><img src="images/logo.png" style="width:100px;height:100px;"/></div>
  ...
  <div class="thongtin">
	...
	Điện thoại: <?php echo $dienthoai?>
  </div>
  <br/>
  <br/>
...
?>
	...
	<tr>
      ...
      <td class="cotSo"><?php echo number_format($phiship,0,".",".")?></td>
    </tr>
	<tr style="color: red">
      <td colspan="3" class="tong">Phải thanh toán</td>
      <td class="cotSo"><?php echo number_format($thanhtoan,0,".",".")?></td>
    </tr>
  </table>
  <div class="thongtin">
	<br/><br/>
  ...
  <div class="footer-left"> Thành phố Hồ Chí Minh, <?php echo $ngaydathang?> <br/>
    Khách hàng <br/>
	<div class="kiten"><?php echo $khachhang ?></div> </div>
  <div class="footer-right"> Thành phố Hồ Chí Minh, <?php echo $ngaydathang?> <br/>
    Nhân viên <br/>
	<div class="kiten"><?php echo $nhanvien ?></div> </div>
	<br/><br/><br/><br/>
	<a href="index.php" class="btn btn-success" name="addbuy"><i class="fa fa-undo"></i>Quay lại trang chủ</a>
